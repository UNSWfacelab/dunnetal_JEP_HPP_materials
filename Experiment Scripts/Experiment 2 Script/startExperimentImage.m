...
startExperimentText = 'At the start of each trial you will be shown several images of faces on screen.';
startExperimentText2 = 'You will need to memorise all these images.';
startExperimentText3 = 'Your task is to decide whether the image shown on the second screen is different to the one in the same place on the first screen.';
startExperimentText4 = 'Press the UP KEY if you think the images are all the SAME. Press the DOWN KEY if you think one image is DIFFERENT.';
