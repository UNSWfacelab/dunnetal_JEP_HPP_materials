...
gridAssignment = [];
        ...
        targetArrayPosition{9}(:,1) = [X0-targetIm_width/2-targetIm_width-imageGap, Y0-targetIm_height/2-targetIm_height-imageGap, X0-targetIm_width/2-imageGap, Y0-targetIm_height/2-imageGap];
        targetArrayPosition{9}(:,2) = [X0-targetIm_width/2, Y0-targetIm_height/2-targetIm_height-imageGap, X0+targetIm_width/2, Y0-targetIm_height/2-imageGap];
        targetArrayPosition{9}(:,3) = [X0+targetIm_width/2+imageGap, Y0-targetIm_height/2-targetIm_height-imageGap, X0+targetIm_width/2+targetIm_width+imageGap, Y0-targetIm_height/2-imageGap];
        targetArrayPosition{9}(:,4) = [X0-targetIm_width/2-targetIm_width-imageGap, Y0-targetIm_height/2, X0-targetIm_width/2-imageGap, Y0+targetIm_height/2];
        targetArrayPosition{9}(:,5) = [X0-targetIm_width/2, Y0-targetIm_height/2, X0+targetIm_width/2, Y0+targetIm_height/2];
        targetArrayPosition{9}(:,6) = [X0+targetIm_width/2+imageGap, Y0-targetIm_height/2, X0+targetIm_width/2+targetIm_width+imageGap, Y0+targetIm_height/2];
        targetArrayPosition{9}(:,7) = [X0-targetIm_width/2-targetIm_width-imageGap, Y0+targetIm_height/2+imageGap, X0-targetIm_width/2-imageGap, Y0+targetIm_height/2+targetIm_height+imageGap];
        targetArrayPosition{9}(:,8) = [X0-targetIm_width/2, Y0+targetIm_height/2+imageGap, X0+targetIm_width/2, Y0+targetIm_height/2+targetIm_height+imageGap];
        targetArrayPosition{9}(:,9) = [X0+targetIm_width/2+imageGap, Y0+targetIm_height/2+imageGap, X0+targetIm_width/2+targetIm_width+imageGap, Y0+targetIm_height/2+targetIm_height+imageGap];
        ...
        targetArrayPosition{16}(:,6) = [X0-targetIm_width-imageGap,Y0-targetIm_height-imageGap,X0-imageGap,Y0-imageGap];
        targetArrayPosition{16}(:,7) = [X0+imageGap,Y0-targetIm_height-imageGap,X0+targetIm_width+imageGap,Y0-imageGap];
