function takeBreak(windowPtr,windowWidth,windowHeight,v_where,spaceKey)
...
halfWayText = 'Please take a short break before pressing the SPACE key to continue';
DrawFormattedText(windowPtr, halfWayText, 'center', 'center', textcolour, wrapat, [], [], vSpacing);
