...
startExperimentText = 'At the start of each trial you will be shown either ONE or TWO images of a face on screen.';
startExperimentText2 = 'Once this disappears you will be shown a search array. You will be required to click on all matching images of the targets as fast as you can.';
startExperimentText3 = 'You will need to select the images that are EXACTLY the same as the TARGET.';
startExperimentText4 = 'Once you correctly select an image it will disappear. After you find all the faces the trial will automatically end.';
startExperimentText5 = 'If you make 6 consecutive mistakes however, the trial will terminate immediately and you will suffer a time penalty before beginning the next trial.';
